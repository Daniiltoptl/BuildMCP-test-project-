...
LIGHTING = {
    ...
    "day": ((0.62, 0.62, 1.0, 0.96, 0.88, 0.35, 0.84, 0.9, 1.0, 1, 1), 0, (0.36, 0.8, 0.48)),
    "sunset": ((0.40, 0.8, 1.0, 0.66, 0.42, 0.7, 0.78, 0.72, 0.92, 1, 1), 2, (-0.93, 0.26, 0.25)),
    "night": ((0.2, 0.0, 0.0, 0.0, 0.0, 1.45, 0.55, 0.66, 1.0, 0, 1), 3, (0.2, 0.9, 0.3)),
}
