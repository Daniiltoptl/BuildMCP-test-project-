...
register(Theme(
    ...
    rock_deep=patches({"deepslate": 4, "cobbled_deepslate": 2, "tuff": 2, "andesite": 1}, size=4),
    underside=patches({"tuff": 2, "deepslate": 3, "cobbled_deepslate": 1.5, "dripstone_block": 1}, size=4),
...
register(Theme(
    ...
    rock_deep=patches({"deepslate": 3, "tuff": 2, "andesite": 1}, size=4),
    underside=patches({"tuff": 2, "deepslate": 2, "andesite": 1}, size=4),
